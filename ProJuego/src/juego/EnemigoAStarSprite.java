...
public class EnemigoAStarSprite extends EnemigoSprite
{
  private final static int MAX_MOVES = 5;  //Número máximo de movimientos antes que la recalculación del camino sea permitida.
  ...
  public EnemigoAStarSprite(int x, int y, int w, int h, CargaImagenes imsLd,
                                    DesarrolloMapa wd)
